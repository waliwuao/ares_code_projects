#include "myrobot_controller/simple_controller.hpp"
    ...
    : Node(name)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/myrobot_controller/cmd_vel", 10,
...
void SimpleController::velCallback(const geometry_msgs::msg::TwistStamped & msg)
{
    ...
    Eigen::Vector2d wheel_speed = robot_speed;
